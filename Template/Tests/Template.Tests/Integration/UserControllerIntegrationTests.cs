...
namespace Template.Tests.Integration
{
    public class UserControllerIntegrationTests : IClassFixture<WebApiTemplateFactory>
    {
        ...
        [Fact]
        public async Task GetTemplates_ShouldReturnUserTemplates()
        {
            // Arrange
            var (userId, templateIds) = await SeedUserWithTemplatesAsync();

            // Act
            var response = await _client.GetAsync($"/api/user/{userId}/templates");
        ...
        public async Task GetTemplates_ShouldReturnNotFound_WhenUserDoesNotExist()
        {
            ...
            // Act
            var response = await _client.GetAsync($"/api/user/{nonExistentId}/templates");
        ...
        [Fact]
        public async Task GetTemplates_ShouldReturnEmptyList_WhenUserHasNoTemplates()
        {
            // Arrange
            var userId = await SeedDataAsync();
