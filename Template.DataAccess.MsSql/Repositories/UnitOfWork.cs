...
using Template.DataAccess.MsSql.Repositories; // <-- Add this for QuestionRepository
...
namespace Template.DataAccess.MsSql.Repositories
{
        ...
        ILoggerFactory loggerFactory) : IUnitOfWork
    {
        ...
        private IQuestionRepository _questionRepository; // <-- Add this field
        ...
        public IQuestionRepository QuestionRepository => // <-- Add this property
